...
enum token_kind {
    ...
    TOKEN_TESTS, TOKEN_FIXTURES,
    TOKEN_FAIL, TOKEN_UNDO, TOKEN_HERE, TOKEN_FALLTHROUGH, TOKEN_VARIANT,
    TOKEN_RESERVED,
    ...
    TOKEN_SHR_ASSIGN, TOKEN_QUESTION, TOKEN_QUESTION_STAR, TOKEN_ATOMIC,
    TOKEN_DISPATCH,
