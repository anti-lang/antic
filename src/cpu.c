...
static const struct {
    ...
    [CPU_V1] = {"v1", ARCH_X86_64, ANTI_CPU_X86_64_V1, 0, "x86-64", "", 16},
    [CPU_V2] = {"v2", ARCH_X86_64, ANTI_CPU_X86_64_V2, CPU_SSE4, "x86-64-v2",
                "", 16},
    [CPU_V3] = {"v3", ARCH_X86_64, ANTI_CPU_X86_64_V3, CPU_SSE4 | CPU_AVX,
                "x86-64-v3", "", 32},
...
{
    return levels[level].vector_bytes;
}
