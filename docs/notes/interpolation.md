...
- The parser takes nothing after the literal. An argument list there is a call of the `str` the literal gives, which the checker refuses as `` cannot call `str` ``.
