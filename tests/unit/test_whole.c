...
static void devirtualises(void)
{
    passes(true,
           ...
           "    %15 = add i64 %7, %12\n"
           "    %16 = load ptr %1\n"
           "    %17 = mul i64 8, size_of ptr\n"
           "    %18 = ptradd %16, %17\n"
           "    %19 = load ptr %18\n"
           "    %20 = call i64 %19 via @main.fn.0(%1) table @main.Named.descriptor 8\n"
           "    %21 = addov i8 %15, %20\n"
           "    branch %21, b3, b4\n"
           "b3:\n"
           "    %22 = addr @main.46\n"
           "    call void @anti_rt_check_failed(%22, 22, 1, %15, %20)\n"
           "    jump b4\n"
           "b4:\n"
           "    %23 = add i64 %15, %20\n"
           "    %24 = load ptr %2\n"
           "    %25 = mul i64 8, size_of ptr\n"
           "    %26 = ptradd %24, %25\n"
           "    %27 = load ptr %26\n"
           "    %28 = call i64 @main.Tile.area(%2)\n"
           "    %29 = addov i8 %23, %28\n"
           "    branch %29, b5, b6\n"
           "b5:\n"
           "    %30 = addr @main.46\n"
           "    call void @anti_rt_check_failed(%30, 22, 1, %23, %28)\n"
           "    jump b6\n"
           "b6:\n"
           "    %31 = add i64 %23, %28\n"
           "    ret i64 %31\n"
    ...
    passes(false,
           ...
           "    %26 = ptradd %24, %25\n"
           "    %27 = load ptr %26\n"
           "    %28 = call i64 %27 via @main.fn.0(%2) table @main.Tile.descriptor 8\n"
           "    %29 = addov i8 %23, %28\n"
           "    branch %29, b5, b6\n"
           "b5:\n"
           "    %30 = addr @main.46\n"
