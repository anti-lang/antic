...
void test_lower(void)
{
    ...
    lowers("struct Flags { visible: u32 : 1, level: i8 : 3 }\n"
           ...
           "global main.Flags.descriptor anti.rt.Descriptor { @main.1, i64 5, ptr 0, size_of main.Flags, i64 0, ptr 0, i64 2, @main.Flags.fields, ptr 0, i64 0, i64 0, ptr 0, @main.package.version, i64 5, ptr 0 }\n"
    ...
    lowers("packed struct P { a: u8, b: i32 }\n"
           ...
           "extern fn anti_rt_check_failed(ptr, i64, i32, i64, i64)\n"
           "global main.P.descriptor anti.rt.Descriptor { @main.1, i64 1, ptr 0, size_of main.P, i64 0, ptr 0, i64 2, @main.P.fields, ptr 0, i64 0, i64 0, ptr 0, @main.package.version, i64 5, ptr 0 }\n"
           ...
           "global main.package.version size 6 align 1 bytes 30 2e 30 2e 30 00\nglobal main.A.descriptor anti.rt.Descriptor { @main.7, i64 1, ptr 0, size_of main.A, i64 0, ptr 0, i64 1, @main.A.fields, ptr 0, i64 0, i64 0, ptr 0, @main.package.version, i64 5, ptr 0 }\n"
    ...
    lowers("struct H { tag: u8, n: i32 }\n"
           ...
           "extern fn anti_rt_check_failed(ptr, i64, i32, i64, i64)\n"
           "global main.H.descriptor anti.rt.Descriptor { @main.1, i64 1, ptr 0, size_of main.H, i64 0, ptr 0, i64 2, @main.H.fields, ptr 0, i64 0, i64 0, ptr 0, @main.package.version, i64 5, ptr 0 }\n"
           ...
           "global main.package.version size 6 align 1 bytes 30 2e 30 2e 30 00\nglobal main.6 size 28 align 1 bytes 6d 61 69 6e 3a 34 3a 20 69 6e 64 65 78 20 6f 75 74 20 6f 66 20 62 6f 75 6e 64 73 00\n"
    ...
    lowers("struct V { x: f64, y: f64 }\n"
           ...
           "functions: ptr, version: ptr, version_length: i64, versions: ptr }\n"
           ...
           "0, i64 0, ptr 0, @main.package.version, i64 5, ptr 0 }\n"
    ...
    lowers("struct Gap { a: u8, b: i32 }\n"
           ...
           "ptr 0, i64 0, i64 0, ptr 0, @main.package.version, i64 5, ptr 0 }\n"
           ...
           "global main.package.version size 6 align 1 bytes 30 2e 30 2e 30 00\nglobal main.Pair.descriptor anti.rt.Descriptor { @main.7, i64 4, "
           "ptr 0, size_of main.Pair, i64 0, ptr 0, i64 2, @main.Pair.fields, "
           "ptr 0, i64 0, i64 0, ptr 0, @main.package.version, i64 5, ptr 0 }\n"
           "global main.7 size 5 align 1 bytes 50 61 69 72 00\n"
           "global main.8 size 4 align 1 bytes 6f 6e 65 00\n"
           "global main.9 size 4 align 1 bytes 74 77 6f 00\n"
           "global main.Pair.fields [2]anti.rt.Field { anti.rt.Field { "
           "@main.8, i64 3, offset_of main.Pair.one, i64 21, i64 0, "
           "@main.Gap.descriptor }, anti.rt.Field { @main.9, i64 3, offset_of "
    ...
    lowers("struct V { x: f64, y: f64 }\n"
           ...
           "i64 1, offset_of main.V.x, i64 15, i64 0, ptr 0 }, anti.rt.Field { "
           "@main.3, i64 1, offset_of main.V.y, i64 15, i64 0, ptr 0 } }\n"
           "global main.package.version size 6 align 1 bytes 30 2e 30 2e 30 00\nglobal main.6 main.V { f64 1, f64 1 }\n"
           "fn main.apply() -> f64 {\n"
           "b0:\n"
           "    %0 = slot main.V\n"
           "    %2 = slot main.V\n"
    ...
    lowers("fn twice(x: int) -> int {\n"
           "    return x * 2;\n"
           "}\n"
           "fn apply(keep f: fn(int) -> int, x: int) -> int {\n"
           "    return f(x);\n"
           "}\n"
           "fn main() -> int {\n"
           "    let g = twice;\n"
    ...
    /* DESIGN: a parameter that does not keep its argument is two IR
       parameters, the code and the context, which the body joins into
       one pair. A named function passes the context `none`. A closure
       passes the record of the addresses it captures, and a call through
       the pair passes the context after the arguments. */
    lowers("fn twice(x: int) -> int {\n"
           "    return x * 2;\n"
           "}\n"
           ...
           "fn main() -> int {\n"
           "    let k = 3;\n"
           "    return apply(twice, 3) + apply(fn(n) { return n + k; }, 1);\n"
           "}\n",
           ...
           "    ret i64 %1\n"
           "}\n"
           "fn main.apply(%0: ptr, %1: ptr, %2: i64) -> i64 {\n"
           "b0:\n"
           "    %3 = slot fn(...)\n"
           "    store ptr %0, %3\n"
           "    %4 = ptradd %3, offset_of fn(...).context\n"
           "    store ptr %1, %4\n"
           "    %5 = load ptr %3\n"
           "    %6 = ptradd %3, offset_of fn(...).context\n"
           "    %7 = load ptr %6\n"
           "    %8 = call i64 %5 via @main.fn.0(%2, %7)\n"
           "    ret i64 %8\n"
           "}\n"
           "fn main.main() -> i64 {\n"
           "b0:\n"
           ...
           "    %6 = load ptr %5\n"
           "    %7 = call i64 @main.apply(%4, %6, 3)\n"
           "    %8 = addr @main.main.0\n"
           "    store ptr %0, %9\n"
           "    store ptr %8, %10\n"
           "    %11 = ptradd %10, offset_of fn(...).context\n"
           "    store ptr %9, %11\n"
           "    %12 = load ptr %10\n"
           "    %13 = ptradd %10, offset_of fn(...).context\n"
           "    %14 = load ptr %13\n"
           "    %15 = call i64 @main.apply(%12, %14, 1)\n"
           "    %16 = addov i64 %7, %15\n"
           "    branchov %16, b1, b2\n"
           "b1:\n"
           "    %17 = addr @main.1\n"
    ...
    lowers("extern fn abs(x: i32) -> i32;\n"
           ...
           "global main.Ops.descriptor anti.rt.Descriptor { @main.1, i64 3, ptr 0, size_of main.Ops, i64 0, ptr 0, i64 2, @main.Ops.fields, ptr 0, i64 0, i64 0, ptr 0, @main.package.version, i64 5, ptr 0 }\n"
