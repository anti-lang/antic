...
void test_lower(void)
{
    ...
    lowers("struct Flags { visible: u32 : 1, level: i8 : 3 }\n"
           ...
           "functions: ptr }\n"
           "type main.Flags = struct { visible: i32 : 1 zeroext, level: i8 : 3 "
           "signext }\n"
           ...
           "global main.Flags.descriptor anti.rt.Descriptor { @main.1, i64 5, "
           "ptr 0, size_of main.Flags, i64 0, ptr 0, i64 2, "
           "@main.Flags.fields, ptr 0, i64 0, i64 0, ptr 0 }\n"
           ...
           "global main.Flags.fields [2]anti.rt.Field { anti.rt.Field { "
           "@main.2, i64 7, offset_of main.Flags.visible, i64 0, i64 0, ptr 0 "
           "}, anti.rt.Field { @main.3, i64 5, offset_of main.Flags.level, i64 "
           "0, i64 0, ptr 0 } }\n"
           "fn main.f(%0: ptr) -> i8 {\n"
           "b0:\n"
    ...
    lowers("packed struct P { a: u8, b: i32 }\n"
           ...
           "global main.P.descriptor anti.rt.Descriptor { @main.1, i64 1, ptr "
           "0, size_of main.P, i64 0, ptr 0, i64 2, @main.P.fields, ptr 0, i64 "
           "0, i64 0, ptr 0 }\n"
           "global main.1 size 2 align 1 bytes 50 00\n"
           "global main.2 size 2 align 1 bytes 61 00\n"
           "global main.3 size 2 align 1 bytes 62 00\n"
           "global main.P.fields [2]anti.rt.Field { anti.rt.Field { @main.2, "
           "i64 1, offset_of main.P.a, i64 8, i64 0, ptr 0 }, anti.rt.Field { "
           "@main.3, i64 1, offset_of main.P.b, i64 5, i64 0, ptr 0 } }\n"
           "global main.A.descriptor anti.rt.Descriptor { @main.6, i64 1, ptr "
           "0, size_of main.A, i64 0, ptr 0, i64 1, @main.A.fields, ptr 0, i64 "
           "0, i64 0, ptr 0 }\n"
           "global main.6 size 2 align 1 bytes 41 00\n"
           "global main.A.fields [1]anti.rt.Field { anti.rt.Field { @main.2, "
           "i64 1, offset_of main.A.a, i64 8, i64 0, ptr 0 } }\n"
    ...
    lowers("struct H { tag: u8, n: i32 }\n"
           ...
           "i64, type: i64, owned: i64, descriptor: ptr }\n"
           "type [2]anti.rt.Field = array 2 of anti.rt.Field\n"
           "type [size_of(main.H) - 4]byte = array sub i64(size_of main.H, 4) "
           "of i8\n"
           "global main.H.descriptor anti.rt.Descriptor { @main.1, i64 1, ptr "
           "0, size_of main.H, i64 0, ptr 0, i64 2, @main.H.fields, ptr 0, i64 "
           "0, i64 0, ptr 0 }\n"
           ...
           "global main.H.fields [2]anti.rt.Field { anti.rt.Field { @main.2, "
           "i64 3, offset_of main.H.tag, i64 8, i64 0, ptr 0 }, anti.rt.Field "
           "{ @main.3, i64 1, offset_of main.H.n, i64 5, i64 0, ptr 0 } }\n"
           "fn main.f() -> i64 {\n"
           "b0:\n"
    ...
    lowers("struct P { x: int, y: i32 }\n"
           ...
           "global main.P.fields [2]anti.rt.Field { anti.rt.Field { @main.2, "
           "i64 1, offset_of main.P.x, i64 6, i64 0, ptr 0 }, anti.rt.Field { "
           "@main.3, i64 1, offset_of main.P.y, i64 5, i64 0, ptr 0 } }\n"
    ...
    lowers("extern fn abs(x: i32) -> i32;\n"
           ...
           "global main.Ops.descriptor anti.rt.Descriptor { @main.1, i64 3, "
           "ptr 0, size_of main.Ops, i64 0, ptr 0, i64 2, @main.Ops.fields, "
           "ptr 0, i64 0, i64 0, ptr 0 }\n"
           ...
           "global main.Ops.fields [2]anti.rt.Field { anti.rt.Field { @main.2, "
           "i64 5, offset_of main.Ops.unary, i64 18, i64 0, ptr 0 }, "
           "anti.rt.Field { @main.3, i64 6, offset_of main.Ops.narrow, i64 18, "
           "i64 0, ptr 0 } }\n"
