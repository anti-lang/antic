...
void test_lower(void)
{
    ...
    lowers("packed struct P { a: u8, b: i32 }\n"
           ...
           "global main.package.version size 6 align 1 bytes 30 2e 30 2e 30 00\nglobal main.A.descriptor anti.rt.Descriptor { @main.7, i64 1, ptr 0, size_of main.A, i64 0, ptr 0, i64 1, @main.A.fields, ptr 0, i64 0, i64 0, ptr 0, @main.package.version, i64 5, ptr 0, i64 0, ptr 0 }\n"
    ...
    lowers("struct V { x: f64, y: f64 }\n"
           ...
           "0, i64 0, ptr 0, @main.package.version, i64 5, ptr 0, i64 0, ptr 0 }\n"
