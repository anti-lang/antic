...
void test_lower(void)
{
    ...
    lowers("struct Flags { visible: u32 : 1, level: i8 : 3 }\n"
           ...
           "b2:\n"
           "    %6 = sub i8 %1, 2\n"
           "    bitstore i8 %6, %0, main.Flags.level\n"
           "    %7 = bitload i8 %0, main.Flags.level\n"
           "    ret i8 %7\n"
           "}\n");
    ...
    lowers("extern fn labs(n: c_long) -> c_long;\n"
           ...
           "b3:\n"
           "    %13 = addr @main.1\n"
           "    call void @anti_rt_check_failed(%13, 21, 1, %10, %11)\n"
           "    jump b4\n"
           "b4:\n"
           "    %14 = add i64 %10, %11\n"
           "    %15 = trunc i32 %9\n"
           ...
           "b5:\n"
           "    %19 = addr @main.2\n"
           "    call void @anti_rt_check_failed(%19, 34, 2, %18, 0)\n"
           "    jump b6\n"
           "b6:\n"
           "    %20 = trunc i32 %9\n"
           "    %21 = sext i64 %20\n"
           ...
           "b7:\n"
           "    %23 = addr @main.1\n"
           "    call void @anti_rt_check_failed(%23, 21, 1, %14, %21)\n"
           "    jump b8\n"
           "b8:\n"
           "    %24 = add i64 %14, %21\n"
           "    ret i64 %24\n"
    ...
    lowers("struct H { tag: u8, n: i32 }\n"
           ...
           "    %10 = load i8 %9\n"
           "    %11 = zext i64 %10\n"
           "    %12 = addov i8 sub i64(size_of main.H, 4), %11\n"
           "    branch %12, b6, b7\n"
           "b6:\n"
           "    %13 = addr @main.6\n"
           ...
           "    jump b7\n"
           "b7:\n"
           "    %14 = add i64 sub i64(size_of main.H, 4), %11\n"
           "    ret i64 %14\n"
           "}\n");
    lowers("fn scale(x: int) -> int {\n"
           ...
           "b3:\n"
           "    %6 = addr @main.1\n"
           "    call void @anti_rt_check_failed(%6, 21, 1, %0, %4)\n"
           "    jump b4\n"
           "b4:\n"
           "    %7 = mul i64 %0, %4\n"
           "    ret i64 %7\n"
    ...
    lowers("const BIAS: i8 = -128;\n"
           ...
           "b3:\n"
           "    %14 = addr @main.1\n"
           "    call void @anti_rt_check_failed(%14, 35, 2, %13, 0)\n"
           "    jump b4\n"
           "b4:\n"
           "    %15 = zext i16 %11\n"
           "    %16 = addov i8 %10, %15\n"
           ...
           "b5:\n"
           "    %19 = addr @main.2\n"
           "    call void @anti_rt_check_failed(%19, 21, 1, %17, %18)\n"
           "    jump b6\n"
           "b6:\n"
           "    %20 = add i16 %10, %15\n"
           "    ret i16 %20\n"
    ...
    lowers("fn f() -> int {\n"
           ...
           "b2:\n"
           "    %15 = add i64 %10, %12\n"
           "    %16 = ptradd %2, offset_of str.len\n"
           "    %17 = load i64 %16\n"
           "    %18 = addov i8 %15, %17\n"
           "    branch %18, b3, b4\n"
           "b3:\n"
           "    %19 = addr @main.2\n"
           "    call void @anti_rt_check_failed(%19, 21, 1, %15, %17)\n"
           "    jump b4\n"
           "b4:\n"
           "    %20 = add i64 %15, %17\n"
           "    ret i64 %20\n"
    ...
    lowers("fn g(s: str, a: []i32, i: int) -> i32 {\n"
           ...
           "b6:\n"
           "    %32 = add i32 %18, %27\n"
           "    %33 = ptradd %3, offset_of []byte.len\n"
           "    %34 = load i64 %33\n"
           "    %35 = trunc i32 %34\n"
           "    %36 = sext i64 %35\n"
           "    %37 = eq i8 %36, %34\n"
           ...
           "b7:\n"
           "    %38 = addr @main.2\n"
           "    call void @anti_rt_check_failed(%38, 34, 2, %34, 0)\n"
           "    jump b8\n"
           "b8:\n"
           "    %39 = trunc i32 %34\n"
           "    %40 = addov i8 %32, %39\n"
           ...
           "b9:\n"
           "    %43 = addr @main.1\n"
           "    call void @anti_rt_check_failed(%43, 21, 1, %41, %42)\n"
           "    jump b10\n"
           "b10:\n"
           "    %44 = add i32 %32, %39\n"
           "    ret i32 %44\n"
    ...
    lowers("extern fn abs(x: i32) -> i32;\n"
           ...
           "b2:\n"
           "    %11 = add i32 %5, %6\n"
           "    %12 = ptradd %0, offset_of main.Ops.narrow\n"
           "    %13 = load ptr %12\n"
           "    %14 = call i8 %13 via @main.fn.1(1)\n"
           "    %15 = sext i32 %14\n"
           "    %16 = addov i8 %11, %15\n"
           "    %17 = sext i64 %11\n"
           "    %18 = sext i64 %15\n"
