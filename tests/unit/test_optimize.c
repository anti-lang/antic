...
void test_optimize(void)
{
    ...
    optimizes("fn scale(x: int) -> int {\n"
              ...
              "b3:\n"
              "    %4 = addr @main.1\n"
              "    call void @anti_rt_check_failed(%4, 21, 1, %0, 6)\n"
              "    jump b4\n"
              "b4:\n"
              "    %5 = mul i64 %0, 6\n"
              "    ret i64 %5\n"
    ...
    optimizes("struct H { tag: u8, n: i32 }\n"
              ...
              "b5:\n"
              "    %8 = addr @main.7\n"
              "    call void @anti_rt_check_failed(%8, 21, 1, %6, 4)\n"
              "    jump b6\n"
              "b6:\n"
              "    %9 = sub i64 %6, 4\n"
              "    ret i64 %9\n"
    ...
    optimizes("fn f1() -> int { return 7 * 6 - 2; }\n"
              ...
              "b3:\n"
              "    %3 = addr @main.1\n"
              "    call void @anti_rt_check_failed(%3, 21, 1, 42, 2)\n"
              "    jump b4\n"
              "b4:\n"
              "    ret i64 40\n"
              "}\n"
    ...
    optimizes("fn p1(x: int) -> int {\n"
              ...
              "b3:\n"
              "    %4 = addr @main.1\n"
              "    call void @anti_rt_check_failed(%4, 21, 1, %0, 8)\n"
              "    jump b4\n"
              "b4:\n"
              "    %5 = shl i64 %0, 3\n"
              "    %6 = mulov i8 2, %0\n"
              ...
              "b5:\n"
              "    %7 = addr @main.1\n"
              "    call void @anti_rt_check_failed(%7, 21, 1, 2, %0)\n"
              "    jump b6\n"
              "b6:\n"
              "    %8 = shl i64 %0, 1\n"
              "    %9 = addov i8 %5, %8\n"
              ...
              "b7:\n"
              "    %10 = addr @main.0\n"
              "    call void @anti_rt_check_failed(%10, 21, 1, %5, %8)\n"
              "    jump b8\n"
              "b8:\n"
              "    %11 = add i64 %5, %8\n"
              "    %12 = mulov i8 %0, 1\n"
              ...
              "b9:\n"
              "    %13 = addr @main.1\n"
              "    call void @anti_rt_check_failed(%13, 21, 1, %0, 1)\n"
              "    jump b10\n"
              "b10:\n"
              "    %14 = subov i8 %11, %0\n"
              "    branch %14, b11, b12\n"
              "b11:\n"
              "    %15 = addr @main.2\n"
              "    call void @anti_rt_check_failed(%15, 21, 1, %11, %0)\n"
              "    jump b12\n"
              "b12:\n"
              "    %16 = sub i64 %11, %0\n"
              "    ret i64 %16\n"
